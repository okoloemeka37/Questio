...
<div class="min-h-screen bg-gray-100">
    ...
    <div class="mx-auto max-w-5xl px-6 py-8">
        ...
        <div class="mb-8 flex items-center justify-between">
            ...
            <div>
                ...
                <p class="mt-2 text-gray-500">
                    Edit a customer or business field.
                </p>
            </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200
                ...
                <div class="flex items-center gap-4">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path stroke-linecap="round"
                                  ...
                                  d="M11 5H6a2 2 0 00-2 2v11a2
                                     ...
                                     M18.5 2.5a2.121 2.121 0
                                     013 3L12 15l-4 1 1-4 9.5-9.5z"/>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Modify the invoice field details below.
                        </p>
            ...
            <!-- Form -->
            <form class="p-8" method="POST" action="{{ route('InvoiceEditFieldPost',['id'=>$field['id']]) }}">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path stroke-linecap="round"
                                          ...
                                          d="M3 5a2 2 0 012-2h3.28a2
                                             2 0 011.897 1.368L11.18
                                             7.2a2 2 0 01-.45 2.11l-1.27
                                             1.27a16 16 0 006.36 6.36l1.27-1.27
                                             a2 2 0 012.11-.45l2.832 1.003A2
                                             2 0 0121 18.12V21a2 2 0
                                             01-2 2C9.611 23 1 14.389
                                             1 5a2 2 0 012-2z"/>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <div class="pointer-events-none absolute left-0
                                        top-0 flex items-center pl-4 pt-4
                                        text-gray-400">
                            ...
                            <textarea
                                ...
                                class="w-full resize-none rounded-xl border
                                       border-gray-300 bg-white px-4 py-3.5
                                       pl-12 text-gray-800
                                       placeholder-gray-400 outline-none
                                       transition
                                       focus:border-blue-500
